...
import abi from "./contracts/NFT101.json";
import nftMetaData from "./nft_metadata.json";

function App() {

  const contractAddress = '0x0F3bc0D91e5e5c6764B9Cfb3Ff738f1631bc8D20';
  ...
  const mintToken = async (tokenId) => {
    try {
      if (window.ethereum) {
        ...
        const metadataURI = `https://gateway.pinata.cloud/ipfs/QmeCh1eDG5FdnGKbKqS3hjdK3pqL8S5wdfBc9EzgSANSED/${tokenId}.json`
